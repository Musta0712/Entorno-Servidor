...
if(!(isset($_COOKIE["stay-connected"]) || isset($_SESSION["origin"]))){
    $_SESSION["error"] = "· Acceso restringido. Por favor, inicia sesión. ·";
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["accion"])) {
    ...
    if ($_POST["accion"] == "añadir") {
        ...
        // CREAMOS Al Pokemon (Pasamos arrays vacíos para tipos y ataques por ahora)
        $pokemon = new PokemonLegendario(
            $nombre, $numero, $descripcion, [], [], $generacion, $ubicacion, $evento
        );

        // GUARDAMOS
        PokemonLegendarioDAO::create($pokemon);
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["accion"]) && $_POST["accion"] == "eliminar") {
        $id = (int) $_POST["id"];
        PokemonLegendarioDAO::deleteById($id);
    }
}
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="index.php" style="display:inline;">
                                    ...
                                    <input type="hidden" name="id" value="<?= $p->getNumeroPokedex() ?>"> 
