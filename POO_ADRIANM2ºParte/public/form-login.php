...
$email = $nombreUsuario = $password = $type = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$errors) {
        ...
        //Hago lo de la cookie de seguir conectado
            ...
            setcookie("stay-connected", $email, time() + 14*24*60*60, "/"); //caduca a las 2 semanas
            }
     ...
     <main>
        ...
        <?php
            ...
            if (isset($_SESSION["mensaje_exito"])){
                echo "<p class='success'>" . $_SESSION["mensaje_exito"] . "</p>";
                unset($_SESSION["mensaje_exito"]); // Lo borramos para que no se repita
            }
