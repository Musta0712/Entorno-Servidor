<?php if(isset($_SESSION["error"])): ?>
    <div class="error-msg">
        <?= $_SESSION["error"]; ?>
        <?php unset($_SESSION["error"]); // Lo borramos para que no aparezca siempre ?>
    </div>
<?php endif; ?>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!$errors) {
        ...
        elseif (!password_verify($pass, $usuario->getPassword())) {
        ...
        //Hago lo de la cookie de seguir conectado
            ...
            $_SESSION["name"] = $usuario->getNombreUsuario();
            $_SESSION["origin"] = "login";
